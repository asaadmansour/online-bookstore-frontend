...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      path: '',
      loadComponent: () =>
        import('./admin/manage-authors/author-list/author-list')
          .then(m => m.AuthorListComponent),
    },
    {
      path: 'new',
      loadComponent: () =>
        import('./admin/manage-authors/author-form/author-form')
    ...
    },
    {
          ...
          children:[
      {
            path: '',
            loadComponent: () =>
              import('./admin/manage-categories/category-list/category-list')
               .then(m => m.CategoryListComponent),
      },
      {
        path: 'new',
        loadComponent: () =>
          import('./admin/manage-categories/category-form/category-form')
